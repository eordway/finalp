...
--
-- Host: 127.0.0.1
-- Generation Time: May 08, 2019 at 06:42 PM
...
(47, 'Grow', '2002-02-07', NULL, 'http://www.eyezmaze.com/eyezblog_en/blog/2006/12/grow_ver1.html', 'The player is presented with a number of buttons related to characteristics of the game world. Clicking a button will usually result in a change to the corresponding part of the game world. The puzzle is to determine the order in which to push the buttons to achieve the good ending.', 6, 7, 18),
(67, 'Contract Wars', '2012-12-18', '4.64', 'http://www.kongregate.com/games/tfender/contract-wars', 'is the world of the near future in which all power decisions are spent by the private military companies (PMC).  Gain respect fighting side by side with your friends in full-fledged first-person shooter with a great arsenal, RPG features, leveling, achievements and tons of unlocks. Play on different maps in different gamemodes, earn experience points and unlock new weapons and equipment. Câ€™mon, get into fight!', 14, 1, 19),
(68, 'Frog Fractions', '2012-08-05', '0.00', 'http://twinbeard.com/frog-fractions/', 'Welcome to Frog Fractions. You will learn all about fractions!', 15, 12, 21),
(69, 'Robot Unicorn Attack 2', '2013-04-25', '4.30', 'https://www.adultswim.com/games/web/robot-unicorn-attack', 'Robot Unicorn Attack is an epic fantasy platform game in which you must control a wondrous robot unicorn and help them realise their dreams by chasing birds! Your unicorn moves automatically, and you must simply control its jumping and dashing actions - u', 4, 1, 22),
(94, 'Zombie Cluster Pumpkins of Doom', '2002-10-01', '3.16', 'https://www.newgrounds.com/portal/view/64965?random', 'Zombie Cluster Pumpkins of Doom!! (Happy Halloween!)  Use the tailgate net to pull-back and launch various tools. Protect yourself from the oncoming pumpkin hordes. Hit the top pumpkin dead-center to destroy the whole cluster.  Keep an eye out for the poultry-geist!', 17, 2, 24),
(98, 'DuckLife2', '2013-07-13', '4.24', 'https://www.kongregate.com/games/WixGames/ducklife2-world-champion', ' Travel the globe racing your duck to become the world champion.', 19, 1, 26),
(99, 'Medieval Cop 9', '2019-02-27', '4.30', 'https://www.kongregate.com/games/VasantJ/medieval-cop-9-song-silence-part-1', 'The same Song of Lifeâ€¦ The same Silence of Deathâ€¦ And as always, Death will claim Lifeâ€¦ That is the fateâ€¦ of the Horseman.', 14, 1, 27);
...
(7, 'EYEZMAZE', 'http://www.eyezmaze.com/'),
(10, 'Adult Swim ', 'adultswim.com'),
(11, 'Miniclip', 'miniclip.com'),
(12, 'Twinbeard', 'http://twinbeard.com');
...
(17, 'fredsinton', 'freds', 'ffreds@korn.org', 'ffreds', '23c918be57ba48f35679b3b1836c681d'),
(18, 'floop', 'fleep', 'fleep@flopp.org', 'fleepflop', 'd8b377cd1b541d2f01be17f6bcec180f'),
(19, 'ordway', 'em', 'herbivore1336@gmail.com', 'zzombiem', 'cd4cc9d4b724c35dc257f38edfc5cc6b'),
(20, 'reed', 'lou', 'vunderg@yahoo.fr', 'lreed73', '9d782e9fe9cafad37cf6deec3357ecdd'),
(21, 'Beardsley', 'Ally', 'abeards@gmail.com', 'lilbeardsley', '22cc0cfcbfe7612384875272159134ef');
...
--
ALTER TABLE `creator`
  MODIFY `creator_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT for table `games`
--
ALTER TABLE `games`
  MODIFY `game_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100;
